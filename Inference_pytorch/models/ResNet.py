...
def conv3x3(in_planes, out_planes, stride=1, groups=1, dilation=1,args=None,logger=None):
    ...
    if args.mode == "WAGE":
        ...
        conv2d = nn.Conv2d(in_planes, out_planes, kernel_size=3, stride=stride,
...
def conv1x1(in_planes, out_planes, stride=1,args=None,logger=None):
    ...
    if args.mode == "WAGE":
        ...
        conv2d = nn.Conv2d(in_planes, out_planes, kernel_size=1, stride=stride, bias=False)
    return conv2d
...
def Conv2d(in_planes, out_planes, kernel_size, stride, padding, args=None, logger=None):
    ...
    if args.mode == "WAGE":
        ...
        conv2d = nn.Conv2d(in_planes, out_planes, kernel_size, stride, padding, bias=False)
    return conv2d
...
def Linear(in_planes, out_planes, args=None, logger=None):
    ...
    if args.mode == "WAGE":
        ...
        linear = nn.Linear(in_planes, out_planes)
    return linear
